...
var SAN_WHOLE = SAN_WHOLE || {};
SAN_WHOLE.namespace = function( ns_string ) {
    var parts = ns_string.split('.'),
        parent = SAN_WHOLE,
        pl, i;
    if (parts[0] == "SAN_WHOLE") {
        parts = parts.slice(1);
    }
    pl = parts.length;
    for (i = 0; i < pl; i += 1 ) {
...
noIcon: function () {
  return this.get("noIcon");
	...
	window.NavTree__ItemDecoration_View = //S202201012057
	{
		html_root: '<span class="b-tree__spacer"></span>',
		html_expander_doClose: '<span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="�" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span>',
		html_expander_doOpen: '<span class="b-tree__i_expander_doOpen"><img class="b-tree__i_expander_doOpen_inner" alt="+" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span>',
		...
		html_render_folder_expander_angle_tl_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_tl"><span class="b-tree__i_angle_tl_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span></span>',
		html_render_folder_expander_hline_mr_cached: '<span class="b-tree__spacer"><span class="b-tree__i_hLine_mr"><span class="b-tree__i_hLine_mr_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span></span>',
		html_render_folder_expander_angle_bl_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_bl"><span class="b-tree__i_angle_bl_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span></span>',
		html_render_folder_expander_angle_tl_tb_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_tl"><span class="b-tree__i_angle_tl_inner"></span></span><span class="b-tree__i_vLine_tb"><span class="b-tree__i_vLine_tb_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span></span>',
		html_render_folder_expander_doclose_cached: '<span class="b-tree__spacer"><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="' + window['drex_file_path'] + 'SanwholeData/null.gif" /></span></span>',
		...
		renderFolder: function() {
			if (!this.model.hasParent() && (SAN_WHOLE.data_menu.DREX_HAS_ROOT_NODE || SAN_WHOLE.data_menu.DREX_MENU_TYPE == 1))
		...
		renderArticleIcon: function() {
			return this.model.noIcon() ? "" : (this.html_article_icon_cached);
		},
		
		renderChilds: function( ) {
			if ((SAN_WHOLE.data_menu.DREX_HAS_ROOT_NODE || SAN_WHOLE.data_menu.DREX_MENU_TYPE == 1) && !this.model.hasParent())
				return ('');
	...
	window.NavTree__Item_View = Backbone.View.extend({
		...
		initialize: function( options ) {
			this.dataManager = SAN_WHOLE.dataManager;
		},
...
SAN_WHOLE.namespace('SAN_WHOLE.utils.utf8');SAN_WHOLE.utils.utf8={encode:function(string){string=string.replace(/\r\n/g,"\n");var utftext="";for(var n=0;n<string.length;n++){var c=string.charCodeAt(n);if(c<128){utftext+=String.fromCharCode(c);}
...
return string;}};
SAN_WHOLE.namespace('SAN_WHOLE.utils');SAN_WHOLE.utils={base64:SAN_WHOLE.utils.base64,utf8:SAN_WHOLE.utils.utf8,escapeUrl:function(oldUrl)
...
SAN_WHOLE.namespace( 'SAN_WHOLE.data_menu' );
SAN_WHOLE.data_menu = {
DREX_NODE_NAMES: ["Root","Vole Office Suite","Vole Office 套件","Vole Office","Sanwhole Studio","Wanlan Tunnel Office (WTO)","Release Logs发布日志","Vole Internet Expedition (EN)","Vole Internet Expedition (CN)","Vole Windows Expedition (EN)","Vole Windows Expedition (CN)","Vole Word","Vole Excel","Vole Scheduler","Vole Diagram","Vole 4M-Showroom","WTO cloud-based Services","WTO Additional Services (Paid services)","Create a new page","Layout adjustment saving and restoring","Create a new category","New Project","Exporting a scene","Loading a scene","Browser settings","新建网页","布局调整保存和恢复","新建分类","新建项目","导出场景","加载场景","浏览器设置","Built-in file previewer","Built-in file editor","Collaborative Preview","Media Toolbox","VWE 内置文件预览器","内置文件编辑器","协同预览","媒体工具箱","Company Website Service","File Management Service","User Management Service","File Edit Service","File Preview Service","Collaborate Edit Service","Mail Service","Scheduler Service","Contact Service","File Previewer Basic Operations","Text file previewer","Image file previewer","Video file previewer","Other file previewers","Automatic collaborative preview","Manual collaborative preview","文件预览器基本操作","文本文件预览器","图片文件预览器","视频文件预览器","其它文件预览器","自动协同预览","手动协同预览"],
DREX_NODE_LINKS: ["root.htm","Vole Office Suite.html","Vole Office 套件.html","Vole Office.html","Sanwhole Studio.html","Wanlan Tunnel Office (WTO).html","Release Logs发布日志.html","Vole Internet Expedition (EN).html","Vole Internet Expedition (CN).html","Vole Windows Expedition (EN).html","Vole Windows Expedition (CN).html","Vole Word.html","Vole Excel.html","Vole Scheduler.html","Vole Diagram.html","Vole 4M-Showroom.html","WTO cloud-based Services.html","WTO Additional Services (Paid services).html","Create a new page.html","Layout adjustment saving and restoring.html","Create a new category.html","New Project.html","Exporting a scene.html","Loading a scene.html","Browser settings.html","新建网页.html","布局调整保存和恢复.html","新建分类.html","新建项目.html","导出场景.html","加载场景.html","浏览器设置.html","Built-in file previewer.html","Built-in file editor.html","Collaborative Preview.html","Media Toolbox.html","VWE 内置文件预览器.html","内置文件编辑器.html","协同预览.html","媒体工具箱.html","Company Website Service.html","File Management Service.html","User Management Service.html","File Edit Service.html","File Preview Service.html","Collaborate Edit Service.html","Mail Service.html","Scheduler Service.html","Contact Service.html","File Previewer Basic Operations.html","Text file previewer.html","Image file previewer.html","Video file previewer.html","Other file previewers.html","Automatic collaborative preview.html","Manual collaborative preview.html","文件预览器基本操作.html","文本文件预览器.html","图片文件预览器.html","视频文件预览器.html","其它文件预览器.html","自动协同预览.html","手动协同预览.html"],
DREX_NODE_CHILD_START: [1,7,7,7,16,16,18,18,25,32,36,40,40,40,40,40,40,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,54,54,56,56,61,61,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],
DREX_NODE_CHILD_END: [7,7,7,16,16,18,18,25,32,36,40,40,40,40,40,40,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,54,54,56,56,61,61,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],
DREX_MENU_TYPE: 2,
DREX_HAS_ROOT_NODE: 0};
SAN_WHOLE.namespace( 'SAN_WHOLE.data_search' );
SAN_WHOLE.data_search = {
	SANWHOLE_NOT_FOUND: "Nothing was found",
	SANWHOLE_EMPTY_STRING: "Please, enter a string for search!",
	SANWHOLE_IN_PROGRESS: "Searching...",
	SANWHOLE_PREVIEW_MODE_SEARCH_IS_DISABLED_NOTICE : "In the preview mode the search is disabled.",
	SANWHOLE_ERROR_LOCAL_SEARCH : "Google Chrome and Opera 12.02 and above do not support search in local HTML files. Upload your files to web server or use another browser."
};
SAN_WHOLE.namespace( 'SAN_WHOLE.data_resize' );
SAN_WHOLE.data_resize = {
	SANWHOLE_FIT_HEIGHT_TO_WINDOW: (is_touch_device() ? 0 : 0),
